...
> - The substrate source from
>   [github.com/Hollando78/uht-substrate](https://github.com/Hollando78/uht-substrate)
> - A UHT Factory API key (sign in at
>   [factory.universalhex.org](https://factory.universalhex.org))
> - About 30 minutes

## 1. Clone the substrate source

```sh
git clone https://github.com/Hollando78/uht-substrate.git
cd uht-substrate
```
...
substrate's token-generation script (path varies; see the source
repo's README for the exact command at the time of installation).
